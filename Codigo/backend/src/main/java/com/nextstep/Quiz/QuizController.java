...
public class QuizController {
    ...
    // =====================================================================
    @PostMapping
    public ResponseEntity<?> criar(@RequestBody Quiz quiz) {
        try {
            return ResponseEntity.ok(service.salvar(quiz));
    ...
    // =====================================================================
    @PutMapping("/{id}")
    public Quiz atualizar(@PathVariable Long id, @RequestBody Quiz quiz) {
        return service.atualizar(id, quiz);
    }
